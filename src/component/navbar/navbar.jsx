...
const NavBar = ({isLogin, kakaoUser, googleUser, modalLogOut, modalLogin, modalShow, toggle}) => {
  return(
      ...
      <div className={styles.login}>
        {
          ...
          : <>
              ...
              <span className={styles.user} onClick={modalLogOut}>{kakaoUser}</span>
              <span className={styles.user} onClick={modalLogOut}>{googleUser}</span>
